        ...
        <>
            <div className="    right-50   p-4 flex justify-center">
                <Button
                    type="button"
                    onClick={handleOpen}
                    className="w-full md:w-auto px-4 py-3 text-center text-gray-100 bg-orange-600 border border-transparent dark:border-gray-700 hover:border-orange-500 hover:text-orange-700 hover:bg-orange-100 rounded-xl"
                >
                    Buy now
                </Button>
            </div>
            ...
            {open && (
                <div className="fixed inset-0  py-40 px-96 flex-col items-center justify-center bg-black bg-opacity-50 ">
                    <Dialog
                        ...
                        className=""
                    >
                     <div className="bg-orange-300 w-full p-5 rounded-2xl ">
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="input-field w-lg-full w-full p-2 border border-orange-500 rounded"
                                />
                            </div>
                            <div>
                        ...
                        <div className="mt-4 flex space-x-4">
                            ...
                            <Button
                                ...
                                className="px-4 py-3 text-center text-gray-100 bg-orange-600 border border-transparent hover:border-orange-500 hover:text-orange-700 hover:bg-orange-100 rounded-lg"
                            >
                               Confirm
                            </Button>
                        </div>
