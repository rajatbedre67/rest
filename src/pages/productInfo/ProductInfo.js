...
const ProductInfo = () => {
    ...
    return (
        <Layout>
            <section className="py-5 lg:py-16 font-poppins dark:bg-gray-100">
                {loading ?
                    <>
                            ...
                            <div className="flex flex-wrap mb-24 -mx-4">
                                ...
                                <div className="w-full px-4 md:w-1/2">
                                    <div className="lg:pl-20">
                                        <div className="mb-6 ">
                                            <h2 className="max-w-xl mb-6 text-xl font-semibold leading-loose tracking-wide text-gray-900 md:text-2xl dark:text-gray-900">
                                                {product?.title}
                                            </h2>
                                                    ...
                                                    <li>
                                                        <a href="">
                                                            <svg
                                                                ...
                                                                height={16}
                                                                fill="currentColor"
                                                                className="w-4 mr-1 text-red-500 dark:text-gray-900 bi bi-star "
                                                                viewBox="0 0 16 16"
                                                            >
                                        ...
                                        <div className="mb-6">
                                            <h2 className="mb-2 text-lg font-bold text-gray-900 dark:text-gray-900">
                                                Description :
                                            </h2>
