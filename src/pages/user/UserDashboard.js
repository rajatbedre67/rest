...
//                                         const { status } = order
//                                         return (
//                                             <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-orange-100 md:flex-row">
//                                                 {/* main 3  */}
//                                                 <div className="w-full border-r border-orange-100 bg-orange-50 md:max-w-xs">
//                                                     {/* left  */}
//                                                     <div className="p-8">
...
//                                                             </li>
//                                                                     <button onClick={() => deleteProduct(order.id)} className="ml-auto flex flex-col items-end text font-bold bg-orange-400 px-3 rounded-lg">cancel</button>
